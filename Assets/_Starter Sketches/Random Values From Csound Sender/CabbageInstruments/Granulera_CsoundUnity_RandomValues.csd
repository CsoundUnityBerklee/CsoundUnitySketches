...
instr 100
    ...
    //Phase Variation
        kPhaseVar = 0 ;chnget "PhaseVariation"
    ...
    //Pitch
        ...
        gkGlobalTuning   chnget "GlobalTuning"
        ...
        gkGlobalTuning = cent(gkGlobalTuning)
    
        kFreqVar jitter kFreqVarRange, .2 * kFreqVarRate, .5 * kFreqVarRate
        gkFreqTotal = kFreqMIDI + kFreqVar
...
instr Synthesis
    ...
    //OSCILLATORS   
        aGrain1 poscil aWindowEnv * iOsc1Vol, (p4 * iOsc1Semi * iOsc1Cent * gkGlobalTuning) + p8 + aFMOsc, iFn1, p5
        aGrain2 poscil aWindowEnv * iOsc2Vol, (p4 * iOsc2Semi * iOsc2Cent * gkGlobalTuning) + p8 + aFMOsc, iFn2, p5
        aGrain3 poscil aWindowEnv * iOsc3Vol, (p4 * iOsc3Semi * iOsc3Cent * gkGlobalTuning) + p8 + aFMOsc, iFn3, p5

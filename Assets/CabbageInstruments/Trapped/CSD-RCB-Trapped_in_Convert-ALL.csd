...
form caption("Trapped_in_Convert-V1") size(350, 300), guiMode("queue") pluginId("def1")

button  bounds(54, 62, 86, 55) channel("trigSec1") text("Trig-Sec1") textColour("white")
button  bounds(204, 62, 86, 55) channel("stopSec1") text("Stop-Sec1") textColour("white")

hslider bounds(96, 6, 158, 50) channel("masterLvl") range(0, 4, 2, 1, 0.001) text("Master Lvl") textColour("white")
...
event "i", 14,  0.0,    24.12,   0,      11.057,   200,    0.001,  17.8,   0.99
